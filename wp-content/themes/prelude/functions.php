...
add_action( 'after_setup_theme', 'prelude_theme_setup' );
function prelude_theme_setup() {
	// Make theme available for translation.
	load_theme_textdomain( 'prelude', get_template_directory() . '/languages' );
	...
	add_image_size( 'prelude-post-standard', 770, 500, true );
	add_image_size( 'prelude-post-element', 544, 500, true );
	add_image_size( 'prelude-post-widget', 140, 140, true );

	// Register menus
	register_nav_menu( 'top', esc_html__( 'Top Menu', 'prelude' ) );
	register_nav_menu( 'primary', esc_html__( 'Primary Menu', 'prelude' ) );
	register_nav_menu( 'onepage', esc_html__( 'OnePage Menu', 'prelude' ) );
	register_nav_menu( 'bottom', esc_html__( 'Bottom Menu', 'prelude' ) );
...
function prelude_theme_scripts() {
	...
	// Theme Style
	wp_enqueue_style( 'prelude-theme-fonts', get_template_directory_uri() . '/assets/css/theme-fonts.css', array(), '1.0.0' );
	wp_enqueue_style( 'prelude-theme-style', get_stylesheet_uri(), array(), '1.0.0' );
	...
	// Theme Script
	wp_enqueue_script( 'prelude-theme-script', get_template_directory_uri() . '/assets/js/main.js', array( 'jquery' ), '1.0.0', true );
...
add_action( 'wp_enqueue_scripts', 'prelude_output_custom_color' );
function prelude_output_custom_color( $output = NULL ) {
	$output = apply_filters( 'prelude_custom_colors_css', $output );
    wp_add_inline_style( 'prelude-theme-style', $output );
}

// Registers a widget area.
add_action( 'widgets_init', 'prelude_sidebars_init' );
function prelude_sidebars_init() {
	// Sidebar for Blog
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Blog', 'prelude' ),
		'id'            => 'sidebar-blog',
		'description'   => esc_html__( 'Add widgets here to appear in Sidebar Blog.', 'prelude' ),
	...
	// Sidebar for Pages
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Page', 'prelude' ),
		'id'			=> 'sidebar-page',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Page', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Portfolio', 'prelude' ),
		'id'			=> 'sidebar-portfolio',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Portfolio', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	// Sidebar for Shop
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Shop', 'prelude' ),
		'id'			=> 'sidebar-shop',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Shop', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 1', 'prelude' ),
		'id'			=> 'sidebar-footer-1',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 1', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 2', 'prelude' ),
		'id'			=> 'sidebar-footer-2',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 2', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 3', 'prelude' ),
		'id'			=> 'sidebar-footer-3',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 3', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 4', 'prelude' ),
		'id'			=> 'sidebar-footer-4',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 4', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
	...
	register_sidebar( array(
		'name'			=> esc_html__( 'Sidebar Footer 5', 'prelude' ),
		'id'			=> 'sidebar-footer-5',
		'description'	=> esc_html__( 'Add widgets here to appear in Sidebar Footer 5', 'prelude' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h2 class="widget-title"><span>',
		'after_title'	=> '</span></h2>'
