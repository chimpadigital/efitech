...
function prelude_standard_fonts() {
	return array(
...
function prelude_google_fonts_array() {
...
function prelude_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = prelude_google_fonts_array();
	...
	// Subset
	$subset = prelude_get_mod( 'google_font_subsets', 'latin' );
	$subset = $subset ? $subset : 'latin';
	$subset = '&amp;subset='. $subset;

	// Weights
	$weights = array( '100', '200', '300', '400', '500', '600', '700', '800', '900' );
	$weights = apply_filters( 'prelude_google_font_enqueue_weights', $weights, $font );
	$italics = apply_filters( 'prelude_google_font_enqueue_italics', true );

	// Main URL
	$url = prelude_get_google_fonts_url() .'/css?family='. str_replace(' ', '%20', $font ) .':';
	...
	// Enqueue style
	wp_enqueue_style( 'prelude-google-font-'. $handle, $url, false, false, 'all' );
}