...
if ( ! class_exists( 'Prelude_Sanitize_Data' ) ) {
	class Prelude_Sanitize_Data {
...
// Helper function runs the Prelude_Sanitize_Data class
function prelude_sanitize_data( $data = '', $type = '' ) {
	if ( $data && $type ) {
		$class = new Prelude_Sanitize_Data();
