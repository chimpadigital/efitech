...
if ( $filter_font_family != 'Default' ) {
	prelude_enqueue_google_font( $filter_font_family );
...
<div class="prelude-project-grid" data-layout="<?php echo esc_attr( $showcase ); ?>" data-column="<?php echo esc_attr( $column ); ?>" data-column2="<?php echo esc_attr( $column2 ); ?>" data-column3="<?php echo esc_attr( $column3 ); ?>" data-column4="<?php echo esc_attr( $column4 ); ?>" data-gaph="<?php echo esc_attr( $gaph ); ?>" data-gapv="<?php echo esc_attr( $gapv ); ?>" data-filter="<?php echo esc_attr( $filter_data ); ?>">
	...
	<?php if ( $query->have_posts() ) :
		...
		<div id="portfolio" class="cbp">
		    <?php while ( $query->have_posts() ) : $query->the_post();
				wp_enqueue_script( 'prelude-cubeportfolio' ); wp_enqueue_script( 'prelude-magnificpopup' );
