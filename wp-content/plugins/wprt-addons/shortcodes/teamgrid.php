...
<div class="prelude-team-grid <?php echo esc_attr( $cls ); ?>" style="<?php echo esc_attr( $css ); ?>">
    ...
    <?php while ( $query->have_posts() ) : $query->the_post();
    	...
    	<div class="member-item clearfix" style="<?php echo esc_attr( $item_css ); ?>">
    		<div class="inner">
	        	...
	        	if ( prelude_metabox( 'facebook' ) )
        		$socials_html .= '<li class="facebook"><a target="_blank" href="'. esc_url( prelude_metabox( 'facebook' ) ) .'"><i class="fa fa-facebook"></i></a></li>';
