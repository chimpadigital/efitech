...
if ( $icon_display == 'no-icon' ) {
	...
	printf( '<div class="prelude-divider %1$s" style="%2$s"></div><div class="clearfix"></div>', $cls, $css1 );
}
...
if ( $icon_display == 'icon-font' ) {
	...
	printf(
		'<div class="prelude-divider has-icon" style="%1$s">
