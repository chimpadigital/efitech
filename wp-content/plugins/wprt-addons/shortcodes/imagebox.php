...
extract( shortcode_atts( array(
    ...
    'show_url' => '',
    'url_style' => 'link',
    'arrow_hover_color' => 'hover-accent',
...
if ( $url_style == 'link' && $link_url ) {
    ...
    $url_html .= sprintf(
        '<div class="url-wrap">
            <a href="%2$s" target="%3$s" class="prelude-links %5$s" style="%4$s">
...
if ( $url_style == 'arrow' && $link_url ) {
    $url_html .= sprintf(
        ...
        <a target="%2$s" class="prelude-arrow %3$s" href="%1$s">
...
printf(
    '<div class="prelude-image-box clearfix %6$s" style="%7$s" %8$s>
        <div class="item">
            <div class="inner">
                %1$s
