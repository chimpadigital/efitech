...
if ( $name_font_family != 'Default' ) {
	prelude_enqueue_google_font( $name_font_family );
...
if ( $position_font_family != 'Default' ) {
	prelude_enqueue_google_font( $position_font_family );
...
<div class="prelude-team <?php echo esc_attr( $cls ); ?>" data-auto="<?php echo esc_attr( $auto_scroll ); ?>" data-loop="<?php echo esc_attr( $loop ); ?>" data-column="<?php echo esc_attr( $column ); ?>" data-column2="<?php echo esc_attr( $column2 ); ?>" data-column3="<?php echo esc_attr( $column3 ); ?>" data-gap="<?php echo esc_html( $gap ); ?>">
	    ...
	    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
        	<div class="member-item clearfix">
        		<div class="inner">
		        	...
		        	if ( prelude_metabox( 'facebook' )
        			|| prelude_metabox( 'twitter' )
        			|| prelude_metabox( 'linkedin' )
        			|| prelude_metabox( 'google_plus' )
        			|| prelude_metabox( 'instagram' ) ) :

		        	$socials_html .= '<ul class="socials clearfix">';
		        	if ( prelude_metabox( 'facebook' ) )
	        		$socials_html .= '<li class="facebook"><a target="_blank" href="'. esc_url( prelude_metabox( 'facebook' ) ) .'"><i class="fa fa-facebook-f"></i></a></li>';

	        		if ( prelude_metabox( 'twitter' ) )
	        		$socials_html .= '<li class="twitter"><a target="_blank" href="'. esc_url( prelude_metabox( 'twitter' ) ) .'"><i class="fa fa-twitter"></i></a></li>';

	        		if ( prelude_metabox( 'linkedin' ) )
	        		$socials_html .= '<li class="linkedin"><a target="_blank" href="'. esc_url( prelude_metabox( 'linkedin' ) ) .'"><i class="fa fa-linkedin"></i></a></li>';

	        		if ( prelude_metabox( 'google_plus' ) )
	        		$socials_html .= '<li class="google-plus"><a target="_blank" href="'. esc_url( prelude_metabox( 'google_plus' ) ) .'"><i class="fa fa-google-plus"></i></a></li>';

	        		if ( prelude_metabox( 'instagram' ) )
	        		$socials_html .= '<li class="instagram"><a target="_blank" href="'. esc_url( prelude_metabox( 'instagram' ) ) .'"><i class="fa fa-instagram"></i></a></li>';
		        	$socials_html .= '</ul>';
		            ...
		            <?php if ( has_post_thumbnail() ) : ?>
                 	...
                 	<?php if ( prelude_metabox( 'name' ) || prelude_metabox( 'position' ) || prelude_metabox( 'text' ) ) : ?>
                 		<div class="text-wrap">
					        <?php if ( prelude_metabox( 'name' ) ) : ?>
					        	<h4 class="name" style="<?php echo esc_attr( $name_css ); ?>">
					        	<?php echo esc_html( prelude_metabox( 'name' ) ); ?></h4>
					        <?php endif; ?>

					        <?php if ( prelude_metabox( 'position' ) ) : ?>
					        	<h5 class="position" style="<?php echo esc_attr( $position_css ); ?>">
					        	<?php echo prelude_metabox( 'position' ); ?></h5>
					        <?php endif; ?>

					        <?php if ( prelude_metabox( 'text' ) ) : ?>
					        	<div class="text" style="<?php echo esc_attr( $text_css ); ?>">
					        	<?php echo prelude_metabox( 'text' ); ?></div>
					        <?php endif; ?>
