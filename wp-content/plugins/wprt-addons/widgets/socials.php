...
class WPRT_Socials extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_socials',
            esc_html__( 'Socials', 'prelude' ),
            array(
                'classname'   => 'widget_socials',
                'description' => esc_html__( 'Display the socials.', 'prelude' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        $fields = array(
            'twitter' => esc_html__( 'Twitter URL:', 'prelude' ),
            'facebook' => esc_html__( 'Facebook URL:', 'prelude' ),
            'youtube' => esc_html__( 'Youtube URL:', 'prelude' ),
            'vimeo' => esc_html__( 'Vimeo URL:', 'prelude' ),
            'tumblr' => esc_html__( 'Tumblr URL:', 'prelude' ),
            'pinterest' => esc_html__( 'Pinterest URL:', 'prelude' ),
            'linkedin' => esc_html__( 'LinkedIn URL:', 'prelude' ),
            'instagram' => esc_html__( 'Instagram URL:', 'prelude' ),
            'github' => esc_html__( 'Github URL:', 'prelude' ),
            'apple' => esc_html__( 'Apple URL:', 'prelude' ),
            'android' => esc_html__( 'Android URL:', 'prelude' ),
            'behance' => esc_html__( 'Behance URL:', 'prelude' ),
            'dribbble' => esc_html__( 'Dribbble URL:', 'prelude' ),    
            'flickr' => esc_html__( 'Flickr URL:', 'prelude' ),
            'paypal' => esc_html__( 'Paypal URL:', 'prelude' ),
            'soundcloud' => esc_html__( 'Soundcloud URL:', 'prelude' ),
            'spotify' => esc_html__( 'Spotify URL:', 'prelude' )
        ); ?>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e('Width:', 'prelude') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e('Height:', 'prelude') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e('Icon Font Size:', 'prelude') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'rounded' ) ); ?>"><?php esc_html_e('Rounded:', 'prelude') ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'gap' ) ); ?>"><?php esc_html_e('Spacing Between Items:', 'prelude') ?></label>
...
add_action( 'widgets_init', 'register_prelude_socials' );
// Register widget
function register_prelude_socials() {
