...
if (!class_exists('ElfsightTwitterFeedPlugin')) {
    class ElfsightTwitterFeedPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightTwitterFeedPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightTwitterFeedWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightTwitterFeedPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightTwitterFeedWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightTwitterFeedVCElement($config, $this->widgetsApi);
