...
namespace ElfsightTwitterFeedApi\Core;
...
abstract class Api {
    ...
    public function initDebug($debug_mode) {
        if (class_exists('\ElfsightTwitterFeedApi\Debug')) {
            return new \ElfsightTwitterFeedApi\Debug($this, $debug_mode);
        } else {
            return new \ElfsightTwitterFeedApi\Core\Debug($this, $debug_mode);
        }
    }

    public function initOptions($config) {
        if (class_exists('\ElfsightTwitterFeedApi\Options')) {
            return new \ElfsightTwitterFeedApi\Options($this->Helper, $config);
        } else {
            return new \ElfsightTwitterFeedApi\Core\Options($this->Helper, $config);
        }
    }
    ...
    public function setRequestUrl($url, $baseUrl = '')
    {
        $requestUrl = $url;
